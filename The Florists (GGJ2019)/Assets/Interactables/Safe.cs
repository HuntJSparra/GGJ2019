...
public class Safe : Interactable {
    ...
    override public IEnumerator run(Freeroam p) {
        ...
        if (!EventTracker.plantsWatered || !EventTracker.usedDS || !EventTracker.foundBday || !EventTracker.movedBS) {
        	...
        	yield return StartCoroutine(showText("I enter the code, '83120', and the safe opens. \n There's a jounral inside."));
        	...
        	yield return StartCoroutine(showText("January 11th \n Lily told our parents about my condition. They want me to close the shop and focus on my health. But I can’t do that. If I close the shop, I’ll lose business and I’ll lose the store. I have to prevent myself from forgetting!"));
